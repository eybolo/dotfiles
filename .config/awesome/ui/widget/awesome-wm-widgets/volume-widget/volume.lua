...
local utils = require("ui.widget.awesome-wm-widgets.volume-widget.utils")
...
local widget_types = {
	icon_and_text = require("ui.widget.awesome-wm-widgets.volume-widget.widgets.icon-and-text-widget"),
	icon = require("ui.widget.awesome-wm-widgets.volume-widget.widgets.icon-widget"),
	arc = require("ui.widget.awesome-wm-widgets.volume-widget.widgets.arc-widget"),
	horizontal_bar = require("ui.widget.awesome-wm-widgets.volume-widget.widgets.horizontal-bar-widget"),
	vertical_bar = require("ui.widget.awesome-wm-widgets.volume-widget.widgets.vertical-bar-widget"),
}
local volume = {}
